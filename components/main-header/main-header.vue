<template>
    <header class="main-header">
        <main-container>
            <main-logo />
            <span>Години роботи: 10:00 - 20:00</span>
...
import mainSearch from '../main-search/main-search.vue'
import mainButton from '../UI/main-button/main-button.vue'
...
//         name: 'My-account',
//         path: '/my-accounts',
//         icon: '~/assets/svg/my_account.svg',
//         withCounter: false,
//     },
//     {
//         id: 2,
